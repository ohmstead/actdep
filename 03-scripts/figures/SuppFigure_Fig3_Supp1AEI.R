...
for (gigaclass_str in names(gigaclasses)) {
  ...
  print("Loading ERGs/LRGs (voom-ascertained, defined in reviewer_response voom pipeline)...")
  load_dir <- "04-analysis/reviewer_response/voom"
...
if (SAVE_PLOTS) {
  ...
  file_str <- "DGE-heatmap_all_subclasses_voom_"
