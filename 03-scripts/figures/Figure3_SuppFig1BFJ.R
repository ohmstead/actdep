...
# load DEG csvs ----------------------------------------
csv_paths <- list(
  CA1 = "04-analysis/dge_method_comparison/voom/016_CA1-ProS_Glut__EE30m_vs_SE.csv",
  SST = "04-analysis/dge_method_comparison/voom/053_Sst_Gaba__EE30m_vs_SE.csv",
  Astrocyte = "04-analysis/dge_method_comparison/voom/319_Astro-TE_NN__EE30m_vs_SE.csv"
)
...
if (exists('SAVE_PLOTS') & SAVE_PLOTS) {
  save_path = "05-results/Figure3_SuppFig1/raw_R_plots"
