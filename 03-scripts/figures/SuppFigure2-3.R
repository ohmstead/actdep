...
if (exists("SAVE_PLOTS") & SAVE_PLOTS==T) {
  save_path <- "05-results/SuppFigure2-3/raw_R_plots"
  # png
  ggsave(file.path(save_path, "SuppFigure2.png"), pUMI_alone,  width = 6.5, height = 7, dpi = 300)
  ggsave(file.path(save_path, "SuppFigure3.png"), pGene_alone, width = 6.5, height = 7, dpi = 300)
  
  # svg
  ggsave(file.path(save_path, "SuppFigure2.svg"), pUMI_alone,  width = 6.5, height = 7, dpi = 300)
  ggsave(file.path(save_path, "SuppFigure3.svg"), pGene_alone, width = 6.5, height = 7, dpi = 300)
}
## ----