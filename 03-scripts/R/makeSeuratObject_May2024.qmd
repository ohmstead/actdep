...
meta <- meta |> 
  ...
  mutate(activity_condition = case_when(
    activity_condition == 'dSE'  ~ 'SE',
    activity_condition == 'd30m' ~ 'EE30m',
    activity_condition == 'd6h'  ~ 'EE6h',
    activity_condition == 'KA'   ~ 'KA1h'
  )) |> 
...
meta$activity_condition <- factor(meta$activity_condition, levels = c('SE', 'EE30m', 'EE6h', 'KA1h'))
meta$sample <- factor(meta$sample, levels = c(
  'SE1', 'SE2', 'SE3',
  'EE30m1', 'EE30m2', 'EE30m3',
  'EE6h1', 'EE6h2', 'EE6h3',
  'KA1h1', 'KA1h2', 'KA1h3'
))
...
sample_sexes <- data.frame(sample = c('EE30m1',  'EE30m2',  'EE30m3',
                                      'EE6h1',   'EE6h2',   'EE6h3',
                                      'SE1',   'SE2',   'SE3',
                                      'KA1h1',    'KA1h2',    'KA1h3'),
