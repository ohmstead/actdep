...
data_dir <- "/Volumes/jack/seq/analysis_Dec2024_pilot/unfiltered_mats/all-sample/DGE_unfiltered/"
...
meta <- merge(meta, experimental_meta) |> 
  arrange(match(bc_wells, rownames(nuclei@meta.data)))

# put back into Seurat obj
...
allen_meta_path = "04-analysis/Seurats/Dec2024_pilot/nuclei_MapMyCellsh5Seurat_10xWholeMouseBrain(CCN20230722)_HierarchicalMapping_UTC_1734378681105/nuclei_MapMyCellsh5Seurat_10xWholeMouseBrain(CCN20230722)_HierarchicalMapping_UTC_1734378681105.csv"
...
meta <- meta |>
  mutate(sample = str_replace(sample, "30M", "30m")) |>  # lowercase 30m samples
  mutate(sample = str_replace(sample, "6H", "6h")) |>  # lowercase 6h samples
...
meta <- meta |> 
  ...
  arrange(match(bc_wells, rownames(nuclei@meta.data))) |> print(n = 5)
